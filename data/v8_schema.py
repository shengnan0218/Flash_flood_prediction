"""Tensor contract for v8 hydrologic computational graphs with sparse Q/Z observations."""
...
class HydrologicGraphBatch:
    """One same-graph mini-batch under the v8 sparse-observation contract.
