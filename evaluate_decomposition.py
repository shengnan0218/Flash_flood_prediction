"""Evaluate the Q0 / routed-base / final-Q decomposition without retraining."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate Q0 persistence, routed base, and final Q output"
    )
    parser.add_argument(
        "--config",
        default=str(root / "configs/e4_water_balance_lstm_kinematic_wave_gnn.yaml"),
    )
    ...
    output_dir = args.output_dir or (
        ...
        / f"{checkpoint_path.stem}_{args.split.lower()}_decomposition"
    )
